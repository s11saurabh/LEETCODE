...
class Solution {
    public int[][] buildMatrix(int k, int[][] rowConditions, int[][] colConditions) {
        ...
        boolean dfs(int src, Map<Integer, List<Integer>> graph, Set<Integer> visited, Set<Integer> cur_path, List<Integer> res) {
        ...
        List<Integer> topo_sort(int[][] edges) {
        ...
        List<Integer> row_sorting = topo_sort(rowConditions);
        List<Integer> col_sorting = topo_sort(colConditions);
